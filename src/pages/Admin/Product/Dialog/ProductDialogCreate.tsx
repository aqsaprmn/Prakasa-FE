...
import { POSTCreateProduct } from "@app/Services/Product/Product";
  ...
  const { values, errors, setFieldValue, handleSubmit, handleChange } =
    useFormik({
      ...
      onSubmit: async (val, { resetForm }) => {
        try {
          const fetching = await POSTCreateProduct({ body: val });
      ...
      validationSchema: Yup.object().shape({
        ...
        image: Yup.mixed()
          ...
          .test({
            message:
              "Please provide a supported NPWP file type [png, jpg, jpeg]",
          ...
          .test({
            message: "Please provide a supported NPWP file size less than 5mb",
            test: (file: any, context) => {
  ...
  return (
    ...
    >
      <div className="mb-8 flex justify-center">
        <span className="text-md font-semibold">Create New Product</span>
      </div>
