...
import ProductCreateDialog from "./Dialog/ProductDialogCreate";
import ProductEditDialog from "./Dialog/ProductDialogEdit";
import ProductDetailDialog from "./Dialog/ProductDialogDetail";
import { GETListProduct } from "@app/Services/Product";
import { DELETEProduct } from "@app/Services/Product/Product";
...
const ProductAdminPage = () => {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      flex: 1,
      renderCell: (params) => {
        return params.row.sold !== null ? params.row.sold : 0;
      },
    },
    {
      ...columnStandard,
